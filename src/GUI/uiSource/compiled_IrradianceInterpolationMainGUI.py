...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_GBcoefficients)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.tableWidget_GBCoefficients)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_GBinterpolation)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.SpanningRole, self.tableWidget_GBInterpolation)
        ...
        self.pushButton_CSEvaluate = QtWidgets.QPushButton(self.tab_2)
        self.pushButton_CSEvaluate.setEnabled(False)
        self.pushButton_CSEvaluate.setObjectName("pushButton_CSEvaluate")
        self.gridLayout_8.addWidget(self.pushButton_CSEvaluate, 3, 0, 1, 1)
        self.CSChart = QtWidgets.QWidget(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.CSChart.sizePolicy().hasHeightForWidth())
        self.CSChart.setSizePolicy(sizePolicy)
        self.CSChart.setMinimumSize(QtCore.QSize(525, 400))
        self.CSChart.setObjectName("CSChart")
        self.gridLayout_8.addWidget(self.CSChart, 0, 1, 4, 1)
        self.groupBox_CSinterpolation = QtWidgets.QGroupBox(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBox_CSinterpolation.sizePolicy().hasHeightForWidth())
        self.groupBox_CSinterpolation.setSizePolicy(sizePolicy)
        self.groupBox_CSinterpolation.setMinimumSize(QtCore.QSize(449, 110))
        self.groupBox_CSinterpolation.setObjectName("groupBox_CSinterpolation")
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.groupBox_CSinterpolation)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(10, 20, 401, 48))
        ...
        self.label_CSLowerWL = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.label_CSLowerWL.setMinimumSize(QtCore.QSize(120, 20))
        self.label_CSLowerWL.setAlignment(QtCore.Qt.AlignCenter)
        self.label_CSLowerWL.setObjectName("label_CSLowerWL")
        self.gridLayout_9.addWidget(self.label_CSLowerWL, 0, 0, 1, 1)
        self.combo_CSUpperWL = QtWidgets.QComboBox(self.gridLayoutWidget_2)
        self.combo_CSUpperWL.setEnabled(False)
        self.combo_CSUpperWL.setMinimumSize(QtCore.QSize(120, 20))
        self.combo_CSUpperWL.setObjectName("combo_CSUpperWL")
        self.gridLayout_9.addWidget(self.combo_CSUpperWL, 1, 1, 1, 1)
        self.label_CSstep = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.label_CSstep.setMinimumSize(QtCore.QSize(140, 20))
        self.label_CSstep.setAlignment(QtCore.Qt.AlignCenter)
        self.label_CSstep.setObjectName("label_CSstep")
        self.gridLayout_9.addWidget(self.label_CSstep, 0, 2, 1, 1)
        self.lineEdit_CSStep = QtWidgets.QLineEdit(self.gridLayoutWidget_2)
        self.lineEdit_CSStep.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEdit_CSStep.sizePolicy().hasHeightForWidth())
        self.lineEdit_CSStep.setSizePolicy(sizePolicy)
        self.lineEdit_CSStep.setMinimumSize(QtCore.QSize(140, 20))
        self.lineEdit_CSStep.setAlignment(QtCore.Qt.AlignCenter)
        self.lineEdit_CSStep.setObjectName("lineEdit_CSStep")
        self.gridLayout_9.addWidget(self.lineEdit_CSStep, 1, 2, 1, 1)
        self.combo_CSLowerWL = QtWidgets.QComboBox(self.gridLayoutWidget_2)
        self.combo_CSLowerWL.setEnabled(False)
        self.combo_CSLowerWL.setMinimumSize(QtCore.QSize(120, 20))
        self.combo_CSLowerWL.setObjectName("combo_CSLowerWL")
        self.gridLayout_9.addWidget(self.combo_CSLowerWL, 1, 0, 1, 1)
        self.label_CSUpperWL = QtWidgets.QLabel(self.gridLayoutWidget_2)
        self.label_CSUpperWL.setMinimumSize(QtCore.QSize(120, 20))
        self.label_CSUpperWL.setAlignment(QtCore.Qt.AlignCenter)
        self.label_CSUpperWL.setObjectName("label_CSUpperWL")
        self.gridLayout_9.addWidget(self.label_CSUpperWL, 0, 1, 1, 1)
        self.gridLayout_8.addWidget(self.groupBox_CSinterpolation, 0, 0, 1, 1)
        self.groupBox_CSResults = QtWidgets.QGroupBox(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.groupBox_CSResults.sizePolicy().hasHeightForWidth())
        self.groupBox_CSResults.setSizePolicy(sizePolicy)
        self.groupBox_CSResults.setObjectName("groupBox_CSResults")
        self.gridLayout_10 = QtWidgets.QGridLayout(self.groupBox_CSResults)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.formLayout_2 = QtWidgets.QFormLayout()
        self.formLayout_2.setObjectName("formLayout_2")
        self.label_CScoefficients = QtWidgets.QLabel(self.groupBox_CSResults)
        self.label_CScoefficients.setObjectName("label_CScoefficients")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_CScoefficients)
        self.tableWidget_CSCoefficients = QtWidgets.QTableWidget(self.groupBox_CSResults)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.tableWidget_CSCoefficients.sizePolicy().hasHeightForWidth())
        self.tableWidget_CSCoefficients.setSizePolicy(sizePolicy)
        self.tableWidget_CSCoefficients.setAlternatingRowColors(True)
        self.tableWidget_CSCoefficients.setColumnCount(6)
        self.tableWidget_CSCoefficients.setObjectName("tableWidget_CSCoefficients")
        self.tableWidget_CSCoefficients.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_CSCoefficients.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_CSCoefficients.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_CSCoefficients.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_CSCoefficients.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_CSCoefficients.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_CSCoefficients.setHorizontalHeaderItem(5, item)
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.tableWidget_CSCoefficients)
        self.label_CSinterpolation = QtWidgets.QLabel(self.groupBox_CSResults)
        self.label_CSinterpolation.setObjectName("label_CSinterpolation")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.label_CSinterpolation)
        self.tableWidget_CSInterpolation = QtWidgets.QTableWidget(self.groupBox_CSResults)
        self.tableWidget_CSInterpolation.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(1)
        sizePolicy.setHeightForWidth(self.tableWidget_CSInterpolation.sizePolicy().hasHeightForWidth())
        self.tableWidget_CSInterpolation.setSizePolicy(sizePolicy)
        self.tableWidget_CSInterpolation.setAlternatingRowColors(True)
        self.tableWidget_CSInterpolation.setColumnCount(2)
        self.tableWidget_CSInterpolation.setObjectName("tableWidget_CSInterpolation")
        self.tableWidget_CSInterpolation.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_CSInterpolation.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tableWidget_CSInterpolation.setHorizontalHeaderItem(1, item)
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.SpanningRole, self.tableWidget_CSInterpolation)
        spacerItem1 = QtWidgets.QSpacerItem(40, 5, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.formLayout_2.setItem(2, QtWidgets.QFormLayout.SpanningRole, spacerItem1)
        self.gridLayout_10.addLayout(self.formLayout_2, 1, 0, 1, 1)
        self.gridLayout_8.addWidget(self.groupBox_CSResults, 1, 0, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_CSEvaluate.setText(_translate("MainWindow", "Write cubic spline interpolation to file"))
        self.groupBox_CSinterpolation.setTitle(_translate("MainWindow", "Cubic spline interpolation parameters"))
        self.label_CSLowerWL.setText(_translate("MainWindow", "Lower wavelength"))
        self.label_CSstep.setText(_translate("MainWindow", "Interpolation Step (nm)"))
        self.lineEdit_CSStep.setText(_translate("MainWindow", "10"))
        self.label_CSUpperWL.setText(_translate("MainWindow", "Upper wavelength"))
        self.groupBox_CSResults.setTitle(_translate("MainWindow", "Results"))
        self.label_CScoefficients.setText(_translate("MainWindow", "Cubic spline coefficients"))
        item = self.tableWidget_CSCoefficients.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "i"))
        item = self.tableWidget_CSCoefficients.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Segment"))
        item = self.tableWidget_CSCoefficients.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "a_i"))
        item = self.tableWidget_CSCoefficients.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "b_i"))
        item = self.tableWidget_CSCoefficients.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "c_i"))
        item = self.tableWidget_CSCoefficients.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "d_i"))
        self.label_CSinterpolation.setText(_translate("MainWindow", "Cubic spline fit interpolation"))
        item = self.tableWidget_CSInterpolation.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Wavelength (nm)"))
        item = self.tableWidget_CSInterpolation.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Radiance (W/cm^3 sr)"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Cubic Spline"))
